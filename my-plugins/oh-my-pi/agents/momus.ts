...
export const momus: AgentDef = {
  ...
  mode: "subagent",
  systemPrompt: `You are a **practical** work plan reviewer. Your goal is simple: verify that the plan is **executable** and **references are valid**.
...
- Missing or vague QA scenarios are a practical blocker.
