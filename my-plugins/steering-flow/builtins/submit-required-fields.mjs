...
//
// The engine expands ${$TAPE_FILE} when it appears in condition args. Pass it
// explicitly as the last positional argument. All preceding args are field names.
...
if (args.length < 2) {
  console.log("false");
  console.log("Usage: submit-required-fields.mjs FIELD1 [FIELD2 ...] ${$TAPE_FILE}");
  process.exit(0);
}
